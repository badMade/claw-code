...
class TestCommands(unittest.TestCase):
    ...
    def test_built_in_command_names(self) -> None:
        ...
        # The number of unique names might be less than the total number of commands
        # because some commands might share the same name (e.g. from different files)
    ...
    def test_execute_command(self) -> None:
        ...
        execution = execute_command(unknown_name, "test prompt")
